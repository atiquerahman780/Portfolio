  ...
  return (
    ...
    <div>
      ...
      <div className='min-[1048px]:flex justify-around pt-12 pb-24 pl-48 pr-48 max-[1048px]:pl-8 max-[1048px]:pr-8 min-[1048px]:space-x-8 '>
        <div>
      <div className='text-2xl mb-3 font-medium'>Get To Know Me!</div>
      ...
      <Link to="contact" smooth={true} duration={1000} className=" mr-8 cursor-pointer">
      <button className='bg-gray-400 font-medium text-xl pt-2 pb-2 mt-8 pl-8 pr-8 rounded-md'>Contact</button>
         </Link>
      
      </div>
      <div>
        <div className='text-2xl mb-4 max-[1048px]:pt-8 font-medium'>My Skills</div>
        <div className='text-lg'>
         <span className=' bg-gray-300 pl-2 pr-2  rounded-md'>HTML</span> <span className=' bg-gray-300 pl-2 pr-2  rounded-md'>CSS</span> <span className=' bg-gray-300 pl-2 pr-2  rounded-md'>Javascript</span> <span className=' bg-gray-300 pl-2 pr-2  rounded-md'>Git</span> <span className=' bg-gray-300 pl-2 pr-2 rounded-md'>GitHub</span> <span className=' bg-gray-300 pl-2 pr-2 rounded-md'>React</span> <span className=' bg-gray-300 pl-2 pr-2 rounded-md'>Redux</span> <span className=' bg-gray-300 pl-2 pr-2 rounded-md'>Node</span> <span className=' bg-gray-300 pl-2 pr-2  rounded-md'>Express</span> <span className=' bg-gray-300 pl-2 pr-2  rounded-md'>MongoDB</span> <span className=' bg-gray-300 pl-2 pr-2  rounded-md'>vite</span> <span className=' bg-gray-300 pl-2 pr-2  rounded-md'>Parcel</span> <span className=' bg-gray-300 pl-2 pr-2  rounded-md'>EC2 Instance</span> <span className=' bg-gray-300 pl-2 pr-2  rounded-md'>Hosting</span> <span className=' bg-gray-300 pl-2 pr-2  rounded-md'>Domain</span> <span className=' bg-gray-300 pl-2 pr-2  rounded-md'>Payment_Gateway</span> <span className=' bg-gray-300 pl-2 pr-2 rounded-md'>Tailwind</span> 
        </div>
